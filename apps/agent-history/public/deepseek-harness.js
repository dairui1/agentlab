(function initDeepSeekHarnessTracker() {
  ...
  function renderPluginCapabilities() {
    $("pluginCapabilityGrid").replaceChildren(...core.pluginCapabilities.map((capability) => {
      const item = document.createElement("article");
      item.className = "dsh-plugin-capability";
      const header = document.createElement("header");
      const icon = document.createElement("i");
      icon.dataset.lucide = capability.icon;
      icon.setAttribute("aria-hidden", "true");
      const label = document.createElement("span");
      label.textContent = capability.layer;
      ...
      forms.className = "dsh-plugin-forms";
      capability.forms.forEach((form) => {
      ...
      item.append(header, title, description, forms, boundary);
      return item;
    }));
  }
